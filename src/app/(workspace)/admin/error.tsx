...
export default function AdminError({
  ...
  return (
    <div className='flex flex-col items-center justify-center py-20 text-center'>
      <svg width='48' height='48' viewBox='0 0 48 48' fill='none' className='text-[var(--color-error-500)]' aria-hidden='true'>
      ...
      <p className='mt-2 max-w-md text-[var(--color-text-secondary)]' style={{ fontSize: 'var(--text-body-sm)' }}>
        در بارگذاری پنل مدیریت مشکلی پیش آمده است. لطفاً دوباره تلاش کنید.
      </p>
