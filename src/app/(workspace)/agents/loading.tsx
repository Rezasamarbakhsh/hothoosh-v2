    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="h-7 w-32 animate-pulse rounded-lg bg-[var(--color-surface-subtle)]" />
      ...
      {/* Grid skeleton — 3 columns matching gallery layout (Frontend-Arch §4.3) */}
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        {[1, 2, 3, 4, 5, 6].map((i) => (
          <div key={i} className="glass-panel-elevated rounded-xl p-5">
            <div className="flex items-start gap-3">
              <div className="h-11 w-11 animate-pulse rounded-xl bg-[var(--color-surface-subtle)]" />
              <div className="flex-1">
                <div className="h-5 w-28 animate-pulse rounded bg-[var(--color-surface-subtle)]" />
                <div className="mt-2 h-4 w-14 animate-pulse rounded-full bg-[var(--color-surface-subtle)]" />
              </div>
            </div>
